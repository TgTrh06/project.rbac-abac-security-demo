...
const seedUsers = async () => {
  ...
  await User.insertMany([
    { username: "admin", password: hashed, role: "admin", department: "IT", clearance: "top_secret" },
    ...
    { username: "user", password: hashed, role: "user", department: "Public", clearance: "public" },
  ]);
